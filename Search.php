...
<body>
    ...
    <div class="contactwrapper">
        <div id="contactus" class="container">
            <h3 class="wow fadeInUp" data-wow-delay="0.3s">Search</h3>
            ...
            <table border="3" width="100%">
                <tr>
                    ...
                    <?php 
				$c=0;
				$q="select *from restaurantprofile";
				...
				while($row=mysqli_fetch_array($rs))
				{
					...
					?>
                    <td>
                        Rest-Name:&nbsp;&nbsp;&nbsp;<?php print $row['rest_name'];?><br>
                        City:&nbsp;&nbsp;&nbsp;<?php print $row['city'];?><br>
                        Address:&nbsp;&nbsp;&nbsp;<?php print $row['area'];?><br>
                        Contact:&nbsp;&nbsp;&nbsp;<?php print $row['contact'];?><br>
                        Star:&nbsp;&nbsp;&nbsp;<?php print $row['star'];?><br>
                        <a href="search2.php?id=<?php print $row[0];?>">Details</a>
                    </td>
