...
<body>
    ...
    <div class="contactwrapper">
        <div id="contactus" class="container">
            <h3 class="wow fadeInUp" data-wow-delay="0.3s">Review</h3>
            ...
            <form method="post">
                ...
                <table borderstyle="3%" cellspacing="10" cellpadding="10">
                    ...
                    <tr>
                        ...
                        <?php
					$q="select r1.*,r2.* from review r1,user_register r2 where r1.user_id=r2.user_id and r1.rest_id =$rest_id";
                    ...
                    <tr>
                        ...
                        <td><a href="review.php?id=<?php print $row['rev_id'];?>">Delete</a>
