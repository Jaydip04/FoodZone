...
<head>
    <title>User_Register_View</title>
...
<body>
    ...
    <div class="contactwrapper">
        <div id="contactus" class="container">
            <h3 class="wow fadeInUp" data-wow-delay="0.3s">User_Register_View</h3>
            ...
            <form method="post" action="Category_Add_code.php">
                <table style="padding-left:300px;width:500px;text-align:left" height="250" width="450">
                    ...
                    <tr>
                        ...
                        <td><a href="Category_View.php?id=<?php print $row['user_id'];?>">Delete</a> |
