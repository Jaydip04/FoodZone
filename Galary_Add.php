...
<body>
    ...
    <div class="contactwrapper">
        <div id="contactus" class="container">
            <h3 class="wow fadeInUp" data-wow-delay="0.3s">Galary_Add</h3>

            <form method="post" enctype="multipart/form-data" action="Galary_Add_code.php">
                <table style="padding-left:300px;width:500px;text-align:left">
                    <tr>
                        <td> File</td>
                        <td><input class="mytextbox" type="File" name="File" required></td>
