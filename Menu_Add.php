...
<body>
    ...
    <div class="contactwrapper">
        <div id="contactus" class="container">
            <h3 class="wow fadeInUp" data-wow-delay="0.3s">Menu_Add</h3>

            <form method="post" enctype="multipart/form-data" action="Menu_Add_code.php">
                <table style="padding-left:300px;text-align:left">

                    <tr>
                        <td> Title</td>
                        <td><input type="text" class="mytextbox" name="Title" title="only name" type="text"
                    ...
                    <tr>
                        ...
                        <td><select name="Category" required>
                                ...
                                <option value="7"> Sandwish</option>
                                <option value="8"> Deserts</option>
                                <option value="1"> Gujarati</option>
                                <option value="1"> icecream</option>
                                <option value="1"> Sweets</option>
                                <option value="1"> Holiday</option>
                                <option value="1"> Mocktails</option>
                            </select>
                        </td>
                    </tr></br>
                    ...
                    <tr>
                        <td> Photo</td>
                        <td><input type="file" class="mytextbox" name="Photo" required>
                        </td>
                    </tr></br>
