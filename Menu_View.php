...
<body>
    ...
    <div class="contactwrapper">
        <div id="contactus" class="container">
            <h3 class="wow fadeInUp" data-wow-delay="0.3s">Menu_View</h3>

            <a href="Menu_Add.php"> Add New </a>

            <form method="post" action="Menu_Add_code.php">

                <?php
					$rest_id=$_SESSION['rest_id'];
					$q="select * from menu where rest_id='$rest_id'";
					$rs=mysqli_query($cn,$q);
					while($row=mysqli_fetch_array($rs))
					{
						?>
                <table style="padding-left:300px;text-align:left;width:40%;float:left">

                    <tr>
                        <td> <?php print $row['title'];?>
                            <br>
                            <img src="<?php print $row['filename'];?>" width="200px" height="200px" />
                            <br>
                            <a href="Menu_View.php?id=<?php print $row['menu_id'];?>">Delete
                        </td>
                    </tr>
                </table>
