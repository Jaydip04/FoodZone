...
<body>
    ...
    <div class="contactwrapper">
        <div id="contactus" class="container">
            <h3 class="wow fadeInUp" data-wow-delay="0.3s"> Restaurant Login</h3>

            <form method="post" action="rest_login_code.php">
                <table style="padding-left:300px;width:500px;text-align:left">
                    ...
                    <tr>
                        <td> Password </td>
                        <td> <input class="mytextbox" type="password" name="Password" /> </td>
                    </tr>
